...
export default function ProductCard(data, index) {
    ...
    return (
        <div className='w-full p-4' onClick={handleRedirect}>
            <div className='w-full cursor-pointer' onClick={handleRedirect}>
                ...
                <div className='flex w-full items-center text-ml text-gray-300'>
                    ...
                    {data[index]?.vendor?.owner?.city}|
                    {data[index]?.vendor?.name}
                </div>
                <div className='flex w-full items-center text-ml text-gray-300'>
                ...
                <div className='flex  h-15 w-full items-center justify-between'>
                    <div
                        ...
                        className='flex h-7 w-7 cursor-pointer items-center justify-center rounded-sm bg-orange-500 transition-colors hover:bg-orange-800'
                    >
